...
public class FicheProvider extends ContentProvider {

	public static final Uri CONTENT_FICHE_URI = Uri.parse("content://com.lanouveller.provider.fiches/fiches");
  	...
  	public Uri insert(Uri _uri, ContentValues _initialValues) 
  	{
  		...
  		if(rowID > 0) {
  			Uri uri = ContentUris.withAppendedId(CONTENT_FICHE_URI, rowID);
  	...
  	// Alloue l'objet UriMatcher. Une URI terminée par fiches correspondra à une requête sur tous les 'fiches'.
  	// Une URI terminée par'/[rowID]'  correspondra à une ligne unique.
  	static {
  	  	// A Changer lors d'une copie.
  		uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
  		uriMatcher.addURI("com.lanouveller.provider.fiches", "fiches", OBJETS);
  		uriMatcher.addURI("com.lanouveller.provider.fiches", "fiches/#", OBJET_ID);
  	}

  	// La base de données.
  	private SQLiteDatabase database;
  	private static final String TAG = "FicheProvider";
  	private static final String DATABASE_NAME = "franceexpatries_fiches.db";
  	private static final int DATABASE_VERSION = 1;
  	private static final String TABLE = "fiches";
  	...
  	// Indexes.
  	public static final int PAYS_COLUMN = 1;
  	public static final int GUIDE_COLUMN = 2;
  	public static final int TITRE_COLUMN = 3;
  	public static final int CONTENU_COLUMN = 4;
